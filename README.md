...
├── seco_code.py        # 路径参数学习
├── third_code.py       # 查询参数学习
├── fourth_code.py      # 请求体学习
├── fifth_code.py       # 响应类型学习
├── sixth_code.py       # 自定义响应类型和异常响应处理
├── README.md           # 项目说明文档
└── .gitignore          # Git 忽略配置
...
4. **路由不清楚**
   解释：路由即网址＋函数，“/”表示根路径只要打开首页即可调用它的函数，“/....”表示子路径
...
- 2026-04-7: 完成第一个 FastAPI 路径参数的学习，完善 README
- 2026-04-11: 完成一个 FastAPI 查询参数的学习，完善 README
- 2026-04-13: 完成一个 FastAPI 请求体参数、响应类型的学习，完善 README
- 2026-04-15: 完成一个 FastAPI 自定义响应类型、异常响应的学习，完善 README
